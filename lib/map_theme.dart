...
const List<MapTheme> kMapThemes = [
  MapTheme(
    mapNumber: 1,
    name: 'KOZMİK NEBULA',
    subtitle: 'Dallanarak ilerleyen yol',
    lore: 'Yıldızlar arasında kaybolmuş antik bir yol...',
  ...
  MapTheme(
    mapNumber: 2,
    name: 'DERİN OKYANUSLAR',
    subtitle: 'Derinlere inen sular',
    lore: 'Işığın ulaşamadığı karanlık sularda bir yol var...',
  ...
  MapTheme(
    mapNumber: 3,
    name: 'VOLKANİK OCAK',
    subtitle: 'Ateşin kalbi',
    lore: 'Volkanın bağrında yanan kadim bir güç uyandı...',
  ...
  MapTheme(
    mapNumber: 4,
    name: 'DONMUŞ TUNDRA',
    subtitle: 'Buzun sonsuz sessizliği',
    lore: 'Binlerce yıldır donmuş, şimdi çatlıyor...',
  ...
  MapTheme(
    mapNumber: 5,
    name: 'KADIM ORMAN',
    subtitle: 'Ağaçların hafızası',
    lore: 'Her yaprak bir hikaye, her kök bir sır...',
  ...
  MapTheme(
    mapNumber: 6,
    name: 'FIRTINA BULUTLARI',
    subtitle: 'Şimşeğin dansı',
    lore: 'Gökyüzü yarılıyor, fırtına büyüyor...',
  ...
  MapTheme(
    mapNumber: 7,
    name: 'ÇÖL SERABİ',
    subtitle: 'Kumun kayar sırrı',
    lore: 'Yüzlerce yıl önce gömülmüş bir hazine çağırıyor...',
  ...
  MapTheme(
    mapNumber: 8,
    name: 'GÖLGE BOYUTU',
    subtitle: 'Karanlığın geometrisi',
    lore: 'Gerçekliğin ötesinde, geometrik bir labirent...',
  ...
  MapTheme(
    mapNumber: 9,
    name: 'KRİSTAL MAĞARALAR',
    subtitle: 'Işığın kırıldığı yer',
    lore: 'Her kristal, milyonlarca yıllık bir anı taşır...',
  ...
  MapTheme(
    mapNumber: 10,
    name: 'ALTIN TAPINAK',
    subtitle: 'Kadim bilgeliğin kapısı',
    lore: 'Antik tanrılar bu tapınakta uyuyor...',
  ...
  MapTheme(
    mapNumber: 11,
    name: 'NEON ŞEHİR',
    subtitle: 'Dijital labirent',
    lore: '2087. Verinin aktığı şehrin altında bir sır var...',
  ...
  MapTheme(
    mapNumber: 12,
    name: 'KAN AYI',
    subtitle: 'Kırmızı ufkun ötesi',
    lore: 'Ayın kırmızıya büründüğü gecede kapı açıldı...',
  ...
  MapTheme(
    mapNumber: 13,
    name: 'ARKTİK AURORA',
    subtitle: 'Kuzey ışıkları',
    lore: 'Kutup ışığı dans ederken, yolu gösteriyor...',
    primaryColor: Color(0xFF69F0AE),
  ...
  MapTheme(
    mapNumber: 14,
    name: 'KUTSAL IŞIK',
    subtitle: 'İlahi kaderin yolu',
    lore: 'Işığın kendisi yolu aydınlatıyor, sadece inan...',
  ...
  MapTheme(
    mapNumber: 15,
    name: 'BOŞLUK UÇURUMU',
    subtitle: 'Her şeyin sonu ve başlangıcı',
    lore: 'Varoluşun son noktasında sonsuz güç bekliyor...',
