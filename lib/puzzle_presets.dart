    ...
    1: {
      ...
      5: PuzzlePreset(
        ...
        solutionBranches: [
          ...
          // Açılışta 8 ve 9 kullanım sırası ters
          [
            PuzzleMove(5, 8),
            PuzzleMove(7, 5),
            PuzzleMove(0, 7),
          ...
          // Orta oyunda 4 ve 2 toplama sırası varyasyonu
          [
            PuzzleMove(5, 9),
            PuzzleMove(7, 5),
            PuzzleMove(0, 7),
          ...
          // Açılış ters + orta oyun varyasyonu birlikte
          [
            PuzzleMove(5, 8),
            PuzzleMove(7, 5),
            PuzzleMove(0, 7),
      ...
      6: PuzzlePreset(
        ...
        solutionBranches: [
          ...
          // Açılışta 9 ve 10 kullanım sırası varyasyonu
          [
            PuzzleMove(6, 9),
            PuzzleMove(2, 6),
            PuzzleMove(8, 2),
          ...
          // Orta oyunda 3 ve 1 hattı küçük sıra varyasyonu
          [
            PuzzleMove(6, 10),
            PuzzleMove(2, 6),
            PuzzleMove(8, 2),
          ...
          // Açılış ters + kapanışta 9/10 kullanım varyasyonu
          [
            PuzzleMove(6, 9),
            PuzzleMove(2, 6),
            PuzzleMove(8, 2),
      ...
      7: PuzzlePreset(
        ...
        solutionBranches: [
          ...
          // Açılışta 10 yerine 11 kullanımı
          [
            PuzzleMove(9, 11),
            PuzzleMove(1, 9),
            PuzzleMove(4, 1),
          ...
          // Orta oyunda 4 ve 7 hattı küçük sıra farkı
          [
            PuzzleMove(9, 10),
            PuzzleMove(1, 9),
            PuzzleMove(7, 4),
          ...
          // Açılışta 11 kullanımı + orta oyun sıra farkı
          [
            PuzzleMove(9, 11),
            PuzzleMove(1, 9),
            PuzzleMove(7, 4),
      ...
      8: PuzzlePreset(
        ...
        solutionBranches: [
          ...
          // Orta oyunda 4 ve 1 hattı küçük sıra farkı
          [
            PuzzleMove(9, 10),
            PuzzleMove(4, 9),
            PuzzleMove(8, 1),
      ...
      9: PuzzlePreset(
        ...
        solutionBranches: [
          ...
          // Açılışta 11 yerine 12 kullanımı
          [
            PuzzleMove(10, 12),
            PuzzleMove(2, 10),
            PuzzleMove(7, 2),
          ...
          // Orta oyunda 4 ve 9 hattında küçük sıra farkı
          [
            PuzzleMove(10, 11),
            PuzzleMove(2, 10),
            PuzzleMove(7, 2),
          ...
          // Açılışta 12 kullanımı + orta oyun sıra farkı
          [
            PuzzleMove(10, 12),
            PuzzleMove(2, 10),
            PuzzleMove(7, 2),
      ...
      10: PuzzlePreset(
        ...
        solutionBranches: [
          ...
          // Orta oyunda 9 ve 2 hattı küçük sıra farkı
          [
            PuzzleMove(10, 11),
            PuzzleMove(4, 10),
            PuzzleMove(8, 4),
