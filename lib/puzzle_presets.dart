    ...
    1: {
      1: PuzzlePreset(
        ...
        solutionBranches: [
          ...
          // Açılışta boş tüp seçimi ters sırayla da kabul
          [
            PuzzleMove(0, 10),
            PuzzleMove(1, 10),
            PuzzleMove(2, 9),
          ...
          // Hem açılış hem kapanış sıra farkı kabul
          [
            PuzzleMove(0, 10),
            PuzzleMove(1, 10),
            PuzzleMove(2, 9),
        ...
        jokerRecoveryMoves: {
          ...
          // --- AÇILIŞ BLOĞU: 2->9 ve 3->9
          '2,0,4,0|7,6,6,0|4,4,6|7,2,1,1|5,0,2,2|3,7,3,3|8,8,5,4|5,3,7,5|8,1,8,6|1||':
              PuzzleMove(3, 9),

          // Oyuncu önden 0/1 tarafını açtıysa da tanı
          '2,0,4|7,6,6,0|4,4,6,1|7,2,1,1|5,0,2,2|3,7,3,3|8,8,5,4|5,3,7,5|8,1,8,6||0|':
              PuzzleMove(1, 10),
          '2,0,4|7,6,6|4,4,6,1|7,2,1,1|5,0,2,2|3,7,3,3|8,8,5,4|5,3,7,5|8,1,8,6||0,0|':
              PuzzleMove(2, 9),
          '2,0,4|7,6,6|4,4,6|7,2,1,1|5,0,2,2|3,7,3,3|8,8,5,4|5,3,7,5|8,1,8,6|1|0,0|':
              PuzzleMove(3, 9),

          // --- AÇILIŞ BLOĞU: 0->10 ve 1->10
          ...
          // Açılışın öteki varyasyonu tamamlandıktan sonra
          ...
          // Son iki hamle yer değişebilir
          '2,0,4,4|7,6,6,6|4,4,6|7,2|5,0,2,2|3,7,3,3|8,8,5,5|5,3,7|8,1,8|1,1,1|0,0|':
              PuzzleMove(4, 3),

          '2,0,4,4|7,6,6,6|4,4,6|7,2,2,2|5,0|3,7,3,3|8,8,5|5,3,7,5|8,1,8|1,1,1|0,0|':
              PuzzleMove(7, 6),
        },
      ),
      2: PuzzlePreset(
        ...
        jokerRecoveryMoves: {
          ...
          '2,1,1,1|4,5,5|6,1,3,3|2,3,2,2|6,6|4,4,3,4|6,0,5,5||0,0,0|':
              PuzzleMove(0, 7),
          '2|4,5,5|6,1,3,3|2,3,2,2|6,6|4,4,3,4|6,0,5,5|1,1,1|0,0,0|':
              PuzzleMove(3, 0),
          '2,2,2|4,5,5|6,1,3,3|2,3|6,6|4,4,3,4|6,0,5,5|1,1,1|0,0,0|':
              PuzzleMove(2, 3),
          '2,2,2|4,5,5|6,1|2,3,3,3|6,6|4,4,3,4|6,0,5,5|1,1,1|0,0,0|':
              PuzzleMove(2, 7),
          '2,2,2|4,5,5|6|2,3,3,3|6,6|4,4,3,4|6,0,5,5|1,1,1,1|0,0,0|':
              PuzzleMove(3, 9),
          '2,2,2|4,5,5|6|2|6,6|4,4,3,4|6,0,5,5|1,1,1,1|0,0,0|3,3,3':
              PuzzleMove(0, 3),
          '|4,5,5|6|2,2,2,2|6,6|4,4,3,4|6,0,5,5|1,1,1,1|0,0,0|3,3,3':
              PuzzleMove(1, 0),
          '5,5|4|6|2,2,2,2|6,6|4,4,3,4|6,0,5,5|1,1,1,1|0,0,0|3,3,3':
              PuzzleMove(6, 0),
      ...
      3: PuzzlePreset(
        ...
        jokerRecoveryMoves: {
          ...
          // açılış B
          '2,4,4|6,6,0,0|6,1,5,1|6,7,1,1|3,2,3,2|3,7,5,3|7,0,4,4|2,7,5,5||4|':
              PuzzleMove(6, 9),
          '2,4,4|6,6,0,0|6,1,5,1|6,7,1,1|3,2,3,2|3,7,5,3|7,0|2,7,5,5||4,4,4|':
              PuzzleMove(1, 8),
          '2,4,4|6,6|6,1,5,1|6,7,1,1|3,2,3,2|3,7,5,3|7,0|2,7,5,5|0,0|4,4,4|':
              PuzzleMove(0, 8),
